...
async function initDB() {
  ...
  const products = [
    ...
    { name: 'Tablet', owner: users[2]._id, price: 300, image: 'image3.jpg', tags: ['portable', 'Samsung'] },
    { name: 'Monitor', owner: users[3]._id, price: 200, image: 'image4.jpg', tags: ['work', 'LG'] },
    { name: 'Keyboard', owner: users[4]._id, price: 50, image: 'image5.jpg', tags: ['accessory', 'Logitech'] }
  ];
